...
import { BLOG_POSTS, BLOG_PAGE } from '../data/content.js'
    ...
    <div style={{ paddingTop: 68 }}>
      <div style={{ background: '#0f2238', padding: '72px 2rem 56px' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ fontSize: 11, color: '#c19a52', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 16 }}>{tc(BLOG_PAGE, 'badge')}</div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '2rem', alignItems: 'flex-end' }}>
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(28px, 4vw, 50px)', color: '#f4ede1', fontWeight: 400, lineHeight: 1.1 }}>{tc(BLOG_PAGE, 'title')}</h1>
      ...
      <div style={{ background: '#0f2238', padding: '64px 2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          <div style={{ fontSize: 11, color: '#c19a52', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 16 }}>{tc(BLOG_PAGE, 'newsletterBadge')}</div>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: '#f4ede1', fontWeight: 400, marginBottom: 16 }}>{tc(BLOG_PAGE, 'newsletterTitle')}</h2>
          <p style={{ fontSize: 14, color: 'rgba(244,237,225,0.5)', lineHeight: 1.8, marginBottom: 28 }}>
            {tc(BLOG_PAGE, 'newsletterBody')}
          </p>
