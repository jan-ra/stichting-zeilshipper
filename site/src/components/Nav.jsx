...
const NAV_LINK_KEYS = [
  { id: 'vloot',           labelKey: 'fleetLabel' },
  { id: 'informatieborden', labelKey: 'infoBordenLabel' },
  { id: 'unesco',          labelKey: 'unescoLabel' },
  { id: 'team',            labelKey: 'teamLabel' },
  { id: 'media',           labelKey: 'mediaLabel' },
  { id: 'blog',            labelKey: 'blogLabel' },
]
    ...
    <nav style={{
      ...
      {menuOpen && (
        <div style={{
          ...
          {[{ id: 'home', labelKey: 'homeLabel' }, ...NAV_LINK_KEYS].map(link => (
