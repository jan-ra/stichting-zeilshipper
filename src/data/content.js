...
export const SHIPS = [
  { id: 1,  name: "Ortolan",         type: "Klipper", lat: 53.03899397389258,  lng: 4.85089302062988,   port: "Texel",       speed: 4.5, year: 1920, region: "thuiswateren", passengers: 12, image: "/shippics/ortolan.jpg" },
  { id: 2,  name: "Isis",            type: "Klipper", lat: 53.34327549206859,  lng: 5.34124374389648,   port: "Terschelling", speed: 4.2, year: 1912, region: "thuiswateren", passengers: 16, image: "/shippics/isis.jpg" },
  { id: 3,  name: "Morgana",         type: "Klipper", lat: 53.35582807745374,  lng: 5.21507263183594,   port: "Terschelling", speed: 4.8, year: 1908, region: "thuiswateren", passengers: 14, image: "/shippics/morgana.jpg" },
  { id: 4,  name: "Kleine Jager",    type: "Klipper", lat: 52.51334805773167,  lng: 5.05877494812012,   port: "Lelystad",    speed: 3.8, year: 1915, region: "thuiswateren", passengers: 10, image: "/shippics/kleine_jager.webp" },
  { id: 5,  name: "Vliegende Draak", type: "Klipper", lat: 53.17471402523164,  lng: 5.43196678161621,   port: "Harlingen",   speed: 5.2, year: 1907, region: "thuiswateren", passengers: 18, image: "/shippics/Vliegende-Draek.jpg" },
  { id: 6,  name: "Mon Desir",       type: "Klipper", lat: 52.8790762287689,   lng: 5.36647796630859,   port: "Stavoren",    speed: 4.0, year: 1918, region: "thuiswateren", passengers: 12, image: "/shippics/mon_desir.jpg" },
  { id: 7,  name: "Fortuna",         type: "Klipper", lat: 52.69573687295829,  lng: 5.28759956359863,   port: "Enkhuizen",   speed: 3.5, year: 1897, region: "thuiswateren", passengers: 16, image: "/shippics/fortuna.jpg" },
  { id: 8,  name: "Allure",          type: "Klipper", lat: 52.51773554066627,  lng: 5.43720245361328,   port: "Lelystad",    speed: 4.6, year: 1922, region: "thuiswateren", passengers: 14, image: "/shippics/allure.jpg" },
  { id: 9,  name: "Ambiance",        type: "Klipper", lat: 52.69844169820055,  lng: 5.29000282287598,   port: "Enkhuizen",   speed: 4.3, year: 1914, region: "thuiswateren", passengers: 12, image: "/shippics/ambiance.jxl" },
  { id: 10, name: "Oosterschelde",   type: "Klipper", lat: 17.13422880670742,  lng: -62.63442993164063, port: "Sint Kitts",  speed: 7.5, year: 1918, region: "wereld",       passengers: 24, image: "/shippics/Oosterschelde.jpg" },
  { id: 11, name: "Tecla",           type: "Klipper", lat: -0.89809554539895,  lng: -89.60861206054689, port: "Galápagos",   speed: 5.8, year: 1915, region: "wereld",       passengers: 20, image: "/shippics/Tecla.webp" },
  { id: 12, name: "Europa",          type: "Klipper", lat: -12.04158700399934, lng: -77.14067459106447, port: "Lima",        speed: 6.1, year: 1911, region: "wereld",       passengers: 28, image: "/shippics/europa.webp" },
  { id: 13, name: "Eenhoorn",        type: "Klipper", lat: 52.69662116118866,  lng: 5.28880119323731,   port: "Enkhuizen",   speed: 4.4, year: 1910, region: "thuiswateren", passengers: 16, image: "/shippics/eenhoorn.jpg" },
]
