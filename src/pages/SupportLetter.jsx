    ...
    <div style={{ paddingTop: 68, background: '#0b1d30', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#0f2238', padding: '72px 2rem 64px', borderBottom: '1px solid rgba(193,154,82,0.15)' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ fontSize: 10, color: '#c19a52', letterSpacing: '0.22em', textTransform: 'uppercase', marginBottom: 18 }}>{s.badge}</div>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '64px 2rem 100px' }}>
        ...
        {sent ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: '#f4ede1', marginBottom: 20 }}>{s.thankYouTitle}</div>
            <p style={{ fontSize: 15, color: 'rgba(244,237,225,0.55)', lineHeight: 1.8, maxWidth: 440, margin: '0 auto 40px' }}>{s.thankYouBody}</p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1.5rem', marginBottom: 64 }} className="support-pillars">
              {s.pillars.map((p, i) => (
                <div key={i} style={{ borderTop: '2px solid rgba(193,154,82,0.4)', paddingTop: 20 }}>
                  ...
                  <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 16, color: '#f4ede1', marginBottom: 8, lineHeight: 1.3 }}>{p.title}</div>
                  <div style={{ fontSize: 13, color: 'rgba(244,237,225,0.45)', lineHeight: 1.7 }}>{p.body}</div>
                </div>
              ))}
            </div>
